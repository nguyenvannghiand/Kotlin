package com.example.vmmvexample1.model.repositories;
...
public class NicePlaceRepository {
	...
	private void setNicePlaces() {
		dataSet.add(new NicePlace("https://i.redd.it/tpsnoz5bzo501.jpg", "Havasu Falls"));
		...
		dataSet.add(new NicePlace("https://i.redd.it/k98uzl68eh501.jpg", "Havasu Falls"));
		dataSet.add(new NicePlace("https://i.redd.it/j6myfqglup501.jpg", "Frozen Lake"));
